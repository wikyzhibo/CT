...
def train(
    ...
    #in_dim = env.net.low_dim + env.net.n_wafer
    ...
    with set_exploration_type(ExplorationType.RANDOM):
        for batch_idx, tensordict_data in enumerate(collector):
            ...
            if batch_idx % 1 ==0 and batch_idx != 0:
                print(f"batch {batch_idx:04d} | frames={frame_count} | sum_reward={ep_ret:.2f}| overtime={overtime}|makespan={makespan}")
    ...
    torch.save(policy, latest_model_path)
