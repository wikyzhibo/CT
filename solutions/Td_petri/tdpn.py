...
class TimedPetri:
    ...
    def __init__(self) -> None:
        ...
        self.proc = {1: 70, 2: 0, 3: 600, 4: 70, 5: 200, 6:1, 7:1}
        self.debug = False
    ...
    def _tpn_fire(
        ...
        if with_effect:
            ...
            for rn in res_names:
                ...
                module_list = ['PM7', 'PM8', 'PM1', 'PM2', 'PM3', 'PM4', 'LLC', 'LLD', 'PM9', 'PM10']
                itv = Interval(start=int(te), end=int(enter_new), tok_key=tok_key, kind=xx)
