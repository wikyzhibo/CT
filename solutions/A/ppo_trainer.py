...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="PPO 训练（默认并发三动作，可切换单动作）")
    ...
    parser.add_argument("--concurrent", dest="concurrent", action="store_true", default=True, help="启用并发三动作训练（默认开启）")
