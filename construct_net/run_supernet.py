...
if __name__ == "__main__":
    ...
    modules = {
        "LP1": ModuleSpec(tokens=25, ptime=0, capacity=50),
        "LP2": ModuleSpec(tokens=0, ptime=0, capacity=50),
        ...
        "PM7": ModuleSpec(tokens=0, ptime=70, capacity=2),
        #"PM8": ModuleSpec(tokens=0, ptime=70, capacity=1),
        "PM9": ModuleSpec(tokens=0, ptime=200, capacity=2),
        #"PM10": ModuleSpec(tokens=0, ptime=200, capacity=1),
        "PM1": ModuleSpec(tokens=0, ptime=600, capacity=4),
        #"PM2": ModuleSpec(tokens=0, ptime=600, capacity=1),
        #"PM3": ModuleSpec(tokens=0, ptime=600, capacity=1),
        #"PM4": ModuleSpec(tokens=0, ptime=600, capacity=1),
    ...
    robots = {
        ...
        "TM2": RobotSpec(tokens=2, reach={"LLA", "LLB", "LLC", "LLD", "PM7", "PM8", "PM9", "PM10"}),
        "TM3": RobotSpec(tokens=2, reach={"LLC", "LLD", "PM1", "PM2", "PM3", "PM4"}),
    }
    '''
    robots = {
        "TM1": RobotSpec(tokens=1, reach={"LP1", "LP2", "AL", "LLA", "LLB", "LP_done"}),
    ...
    routes = [
        ...
        ["LP2", "AL", "LLA", ["PM7",], ["PM9"], "LLB", "LP_done"]
    ]
